        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <li><a href="{{route('admin.manage-order')}}" class="slide-item">Product Order Manage</a></li>
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                    ...
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="javascript:void(0)">Courier  </a></li>
                        <li><a href="{{route('courier.create')}}" class="slide-item">Courier Add</a></li>
                        <li><a href="{{route('courier.index')}}" class="slide-item">Courier Manage</a></li>
                    </ul>
                </li>
            </ul>
