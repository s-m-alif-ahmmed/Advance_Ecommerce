                        ...
                        <div class="invoice-box mb-5">
                            <table cellpadding="0" cellspacing="0">
                                <tr class="top">
                                    <td colspan="5">
                                        <table>
                                            <tr>
                                                <td class="title">
                                                    <img src="{{asset('/')}}frontEnd/assets/images/logo/logo-large.png" style="width: 100%; max-width: 150px" />
                                                </td>
                                ...
                                <tr class="item">
                                    ...
                                    <td style="text-align: right">{{$item->product_quantity*$item->product_price }}</td>
                                </tr>
                                    @php($sum =$sum + ($item->product_quantity*$item->product_price))
                                @endforeach
                                <tr class="total">
                                    <td colspan="4"></td>
                                    <td>Item Total:(TK){{$sum}}</td>
                                </tr>

                                <tr class="total">
                                    <td colspan="4"></td>
                                    <td>Tax Amount:(TK){{$order->tax_total}}</td>
                                </tr>

                                <tr class="total">
                                    <td colspan="4"></td>
                                    <td>Shipping Amount:(TK){{$order->shipping_total}}</td>
                                </tr>
